...
<div id="minimal-bootstrap-carousel" class="carousel default-home-slider slide carousel-fade shop-slider" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
        ...
        <div class="item active slide-1" style="background-image: url(front-end/images/slider/12.jpg);backgroudn-position: center right;">
        ...
        <div class="item  slide-2" style="background-image: url(front-end/images/slider/11.jpg);backgroudn-position: center right;">
        ...
        <div class="item  slide-3" style="background-image: url(front-end/images/slider/10.jpg);backgroudn-position: center right;">
    ...
    <div class="container clearfix common-pad">
        <div class="row">
            ...
            <div class="col-lg-6 col-md-6 activities-cont">
                ...
                <a href="front-end/lienhe.php?page=lienhe" class="res-btn">Liên hệ<i class="fa fa-arrow-right"></i></a>
                ...
                <div class="row nasir-welboxes">
                    ...
                    <div class="single_wel_cont col-sm-6">
                        <a class="wel-box" href="#">
                            <div class="icon-box"><img src="front-end/images/welcome/icon-3.png" alt="" /></div>
                            <h4>Thay pin</h4>
                    ...
                    <div class="single_wel_cont col-sm-6">
                        <a class="wel-box" href="#">
                            <div class="icon-box"><img src="front-end/images/welcome/icon-1.png" alt="" /></div>
                    ...
                    <div class="single_wel_cont col-sm-6">
                        <a class="wel-box" href="#">
                            <div class="icon-box"><img src="front-end/images/welcome/icon-2.png" alt="" /></div>
                    ...
                    <div class="single_wel_cont col-sm-6">
                        <a class="wel-box" href="#">
                            <div class="icon-box"><img src="front-end/images/welcome/icon-4.png" alt="" /></div>
                ...
                <div class="offer-img-box1">
                    <div class="spa-offer">
                        <div class="img_holder">
                            <img src="front-end/images/our-resort/1.jpg" class="img-responsive" alt="">
                            <div class="overlay">
                ...
                <div class="offer-img-box2">
                    <div class="box1">
                        <div class="img_holder">
                            ...
                            <img src="front-end/images/our-resort/2.jpg" class="img-responsive" alt="">
                            <div class="overlay">
                        ...
                        <div class="box2">
                            ...
                            <div class="img_holder">
                                ...
                                <img src="front-end/images/our-resort/3.jpg" class="img-responsive" alt="">
                                <div class="overlay">
            ...
            <div class="testimonials-wrapper">
                <div class="testimonial-sliders-two">
                    <div class="item">
                        ...
                        <div class="test-bot">
                            <div class="tst-img"><img src="front-end/images/testimonials/1.png" alt="" class="img-responsive"></div>
                    ...
                    <div class="item">
                        ...
                        <div class="test-bot">
                            <div class="tst-img"><img src="front-end/images/testimonials/2.png" alt="" class="img-responsive"></div>
                            <div class="client_name">
                    ...
                    <div class="item">
                        ...
                        <div class="test-bot">
                            <div class="tst-img"><img src="front-end/images/testimonials/3.png" alt="" class="img-responsive"></div>
                            <div class="client_name">
                                <h5><a>Tính Phan - <span>Nescom Technology- Director</span></a></h5>
                                <ul>
                                    <li><a href="#"><i class="fa fa-star"></i></a></li>
                                    <li><a href="#"><i class="fa fa-star"></i></a></li>
                                    <li><a href="#"><i class="fa fa-star"></i></a></li>
                    ...
                    <div class="item">
                        ...
                        <div class="test-bot">
                            <div class="tst-img"><img src="front-end/images/testimonials/4.png" alt="" class="img-responsive"></div>
                            <div class="client_name">
                                <h5><a>Thái Huy - <span>IT</span></a></h5>
                                <ul>
                                    <li><a href="#"><i class="fa fa-star"></i></a></li>
                                    <li><a href="#"><i class="fa fa-star"></i></a></li>
                                    <li><a href="#"><i class="fa fa-star"></i></a></li>
                    ...
                    <div class="item">
                        ...
                        <div class="test-bot">
                            <div class="tst-img"><img src="front-end/images/testimonials/5.png" alt="" class="img-responsive"></div>
                            <div class="client_name">
                                <h5><a>Tường Nguyễn - <span>Nescom Technology- Director</span></a></h5>
                                <ul>
                                    <li><a href="#"><i class="fa fa-star"></i></a></li>
                                    <li><a href="#"><i class="fa fa-star"></i></a></li>
                                    <li><a href="#"><i class="fa fa-star"></i></a></li>

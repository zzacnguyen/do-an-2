            ...
            if($tenanh != null){
                if($_FILES['hinhanh']['type'] == "image/jpeg" || $_FILES['hinhanh']['type'] == "image/png" || $_FILES['hinhanh']['type'] == "image/gif"){
                    ...
                    if($_FILES['hinhanh']['size'] > $maxFileSize){
                        ...
                        $sql = $sql->update('sanpham', array('SP_TENSP' =>$tensp, 'SP_GIA'=>$giasp, 'SP_GIOITHIEU'=>$gioithieusp, 'SP_HINH'=>$tenanh), "`SP_ID` = ".$id);                            
                ...
                $sql = $sql->update('sanpham', array('SP_TENSP' =>$tensp, 'SP_GIA'=>$giasp, 'SP_GIOITHIEU'=>$gioithieusp), "`SP_ID` = ".$id);
            ...
            <div class="box box-primary">
                ...
                <form role="form" action="#" method="post" enctype="multipart/form-data">
                    ...
                    <div class="box-footer">
                        <input type="submit" class="btn btn-primary" name="submit" value="Cập nhật sản phẩm">
                    </div>
                </form>
            </div>
            <!-- /.box -->

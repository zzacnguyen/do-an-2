                ...
                <form role="form" action="#" method="post" enctype="multipart/form-data">
                    <div class="box-body">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Nhập họ tên" name="hoten">
                        </div>
                        <div class="form-group">
                    ...
                    <div class="box-footer">
                        <input type="submit" class="btn btn-primary" value="Thêm liên hệ" name="submit">
                    </div>
                </form>
            </div>
            <!-- /.box -->

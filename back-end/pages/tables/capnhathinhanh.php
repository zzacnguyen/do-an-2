<?php 
    ...
    if($tenanh1 != null || $tenanh2 !=null || $tenanh3 !=null || $tenanh4 !=null || $tenanh5 !=null){
        ...
        $_FILES['hinhanh4']['type'] == "image/jpeg" || $_FILES['hinhanh4']['type'] == "image/png" || $_FILES['hinhanh4']['type'] == "image/gif" ||         $_FILES['hinhanh5']['type'] == "image/jpeg" || $_FILES['hinhanh5']['type'] == "image/png" || $_FILES['hinhanh5']['type'] == "image/gif"){
            ...
            $sql = $sql->update('hinhanh', array('HA_HINH1'=>$tenanh1, 'HA_HINH2'=>$tenanh2, 'HA_HINH3'=>$tenanh3, 'HA_HINH4'=>$tenanh4, 'HA_HINH5'=>$tenanh5), "`HA_ID` = ".$id);
                ...
                <form role="form" action="#" method="post" enctype="multipart/form-data">
                    <div class="box-body">
                        <div class="form-group">
                            ...
                            <span><img src="../../../front-end/images/sanpham/<?php echo $query['HA_HINH1'] ?>" height="161px" width="160px"></span>
                        </div>
                        
                        <div class="form-group">
                            <label for="exampleInputFile">Ảnh 2</label>
                            <input type="file" id="exampleInputFile" name="hinhanh2">
                            <span><img src="../../../front-end/images/sanpham/<?php echo $query['HA_HINH2'] ?>" height="161px" width="160px"></span>
                        </div>
                        
                        <div class="form-group">
                            <label for="exampleInputFile">Ảnh 3</label>
                            <input type="file" id="exampleInputFile" name="hinhanh3">
                            <span><img src="../../../front-end/images/sanpham/<?php echo $query['HA_HINH3'] ?>" height="161px" width="160px"></span>
                        </div>
                        
                        <div class="form-group">
                            <label for="exampleInputFile">Ảnh 4</label>
                            <input type="file" id="exampleInputFile" name="hinhanh4">
                            <span><img src="../../../front-end/images/sanpham/<?php echo $query['HA_HINH4'] ?>" height="161px" width="160px"></span>
                        </div>
                        
                        <div class="form-group">
                            <label for="exampleInputFile">Ảnh 5</label>
                            <input type="file" id="exampleInputFile" name="hinhanh5">
                            <span><img src="../../../front-end/images/sanpham/<?php echo $query['HA_HINH5'] ?>" height="161px" width="160px"></span>
                        </div>
                    </div>
                    <!-- /.box-body -->

                    <div class="box-footer">
                        <input type="submit" class="btn btn-primary" value="Xóa ảnh" name="submit">
                    </div>
                </form>
            </div>
            <!-- /.box -->

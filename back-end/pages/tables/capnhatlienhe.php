				...
				<form role="form" action="#" method="post"
					...
					<div class="box-footer">
						<input type="submit" class="btn btn-primary"
							value="Cập nhật liên hệ" name="submit">
					</div>
				</form>
			</div>
			<!-- /.box -->

<?php 
    ...
    if(!empty($tensp) && !empty($mahinh) && !empty($tinhtrang) && !empty($bosuutap) && !empty($series) && !empty($kichthuoc) && !empty($chatlieu) && !empty($khung) && !empty($loaimay) && !empty($loaidaydeo) && !empty($matquayso) && !empty($chongnuoc) && !empty($gioitinh) && !empty($hienthi) && !empty($mota)){
        $sql = $sql->insert('chitietsp', array('SP_ID' =>''.$tensp, 'HA_ID' =>''.$mahinh, 'CTSP_TINHTRANG' =>''.$tinhtrang, 'CTSP_BOSUUTAP' =>''.$bosuutap, 'CTSP_SERIES' =>''.$series, 'CTSP_KICHTHUOC' =>''.$kichthuoc, 'CTSP_CHATLIEU' =>''.$chatlieu, 'CTSP_KHUNG' =>''.$khung, 'CTSP_LOAIMAY' =>''.$loaimay, 'CTSP_LOAIDAYDEO' =>''.$loaidaydeo, 'CTSP_MATQUAYSO' =>''.$matquayso, 'CTSP_CHONGNUOC' =>''.$chongnuoc, 'CTSP_GIOITINH' =>''.$gioitinh, 'CTSP_CHUCNANGHIENTHI' =>''.$hienthi, 'CTSP_MOTA' =>''.$mota));
                ...
                <form role="form" action="#" method="post" enctype="multipart/form-data">
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Tình trạng" name="tinhtrang">
                        </div>
                        <div class="form-group">
                            <label for="exampleInputEmail1">Bộ sưu tập</label>
                            <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Bộ sưu tập" name="bosuutap">
                        </div>
                        <div class="form-group">
                            <label for="exampleInputEmail1">Series</label>
                            <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Nhập series" name="series">
                        </div>
                        <div class="form-group">
                            <label for="exampleInputEmail1">Kích thước</label>
                            <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Nhập kích thước" name="kichthuoc">
                        </div>
                        <div class="form-group">
                            <label for="exampleInputEmail1">Chất liệu</label>
                            <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Nhập chất liệu" name="chatlieu">
                        </div>
                        <div class="form-group">
                            <label for="exampleInputEmail1">Khung</label>
                            <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Nhập loại khung" name="khung">
                        </div>
                        <div class="form-group">
                            <label for="exampleInputEmail1">Loại máy</label>
                            <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Nhập loại máy" name="loaimay">
                        </div>
                        <div class="form-group">
                            <label for="exampleInputEmail1">Loại dây đeo</label>
                            <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Nhập loại dây đeo" name="loaidaydeo">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Nhập chức năng hiển thị" name="hienthi">
                        </div>
                        <div class="form-group">
                            <label for="exampleInputEmail1">Mô tả</label>
                            <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Nhập mô tả cho sản phẩm" name="mota">
                        </div>
                    </div>
                    <!-- /.box-body -->

                    <div class="box-footer">
                        <input type="submit" class="btn btn-primary" value="Thêm chi tiết" name="submit">
                    </div>
                </form>
            </div>
            <!-- /.box -->

...
<head>
    ...
    <!-- strock gap icons -->
    <link rel="stylesheet" href="front-end/vendors/Stroke-Gap-Icons-Webfont/style.css">
    <link rel="stylesheet" href="front-end/css/animate.min.css">
    <!--    owl-carousel-->
    <link rel="stylesheet" href="front-end/vendors/owlcarousel/owl.carousel.css">
    <link rel="stylesheet" href="front-end/vendors/jquery-ui-1.11.4/jquery-ui.min.css">

    <!-- Main Css  -->
    <link rel="stylesheet" href="front-end/css/style.css">
    <link rel="stylesheet" href="front-end/css/responsive.css">
    <link rel="icon" type="image/png" sizes="16x16" href="front-end/favicon/favicon-16x16.png">
</head>
    ...
    <section class="side-menu" id="sidebarCollapse">
        ...
        <div class="side-menu-widget about-widget">
            <a href="front-end/index.php" class="logo">
                <img src="front-end/images/icon/lr-home.png" alt="Awesome Image" />
            </a>
        ...
        <div class="side-menu-widget gallery-widget">
            ...
            <ul class="list-inline">
                <li>
                    <a><img src="front-end/images/gallery-thumb/1.jpg" width="80px" height="81px" alt="Awesome Image" /></a>
                </li>
                <li>
                    <a><img src="front-end/images/gallery-thumb/2.jpg" width="80px" height="81px" alt="Awesome Image" /></a>
                </li>
                <li>
                    <a><img src="front-end/images/gallery-thumb/3.jpg" width="80px" height="81px" alt="Awesome Image" /></a>
                </li>
                <li>
                    <a><img src="front-end/images/gallery-thumb/4.jpg" width="80px" height="81px" alt="Awesome Image" /></a>
                </li>
                <li>
                    <a><img src="front-end/images/gallery-thumb/5.jpg" width="80px" height="81px" alt="Awesome Image" /></a>
                </li>
                <li>
                    <a><img src="front-end/images/gallery-thumb/6.jpg" width="80px" height="81px" alt="Awesome Image" /></a>
                </li>
                <li>
                    <a><img src="front-end/images/gallery-thumb/7.jpg" width="80px" height="81px" alt="Awesome Image" /></a>
                </li>
                <li>
                    <a><img src="front-end/images/gallery-thumb/8.jpg" width="80px" height="81px" alt="Awesome Image" /></a>
                </li>
            </ul>
            <!-- /.list-inline -->
        ...
        <div class="container">
            <div class="navbar-header">
                ...
                <a href="index.php" class="navbar-brand">
                    <img alt="Awesome Image" src="front-end/images/header/logo2.png">
                </a>
            </div>
            ...
            <div class="collapse navbar-collapse" id="main-navigation">
                <ul class="nav navbar-nav ">
                    <li>
                        <a href="front-end/index.php?page=trangchu">TRANG CHỦ</a>
                    </li>
                    <li>
                        ...
                        <ul class="dropdown-submenu dropdown-menu">
                            <li><a href="front-end/gioithieu.php?page=thongtin">THÔNG TIN</a></li>
                            <li><a href="front-end/baohanh.php?page=baohanh">CHÍNH SÁCH BẢO HÀNH</a></li>
                        </ul>
                    </li>

                    <li>
                        <a href="front-end/sanpham.php?page=sanpham">SẢN PHẨM</a>
                    </li>
